...
%*************************************** Simple AE ****************************************************
file_SimpleAE_Rician3 = matfile('BestModels/Results/SimpleAE/Energy_rician3_c1d2.mat');
file_SimpleAE_Rician10 = matfile('BestModels/Results/SimpleAE/Energy_rician10_c1d2.mat');
file_SimpleAE_Rician20 = matfile('BestModels/Results/SimpleAE/Energy_rician20_c1d2.mat');
file_Feedback_SimpleAE_Rician3 = matfile('BestModels/Results/Feedback_SimpleAE/Energy_rician3_c1d2.mat');
file_Feedback_SimpleAE_Rician10 = matfile('BestModels/Results/Feedback_SimpleAE/Energy_rician10_c1d2.mat');
file_Feedback_SimpleAE_Rician20 = matfile('BestModels/Results/Feedback_SimpleAE/Energy_rician20_c1d2.mat');
...
%*************************************** Control AE ****************************************************
file_ControlAE_Rician3 = matfile('BestModels/Results/ControlAE/Energy_rician3_c1d2.mat');
file_ControlAE_Rician10 = matfile('BestModels/Results/ControlAE/Energy_rician10_c1d2.mat');
file_ControlAE_Rician20 = matfile('BestModels/Results/ControlAE/Energy_rician20_c1d2.mat');
file_Feedback_ControlAE_Rician3 = matfile('BestModels/Results/Feedback_ControlAE/Energy_rician3_c1d2.mat');
file_Feedback_ControlAE_Rician10 = matfile('BestModels/Results/Feedback_ControlAE/Energy_rician10_c1d2.mat');
file_Feedback_ControlAE_Rician20 = matfile('BestModels/Results/Feedback_ControlAE/Energy_rician20_c1d2.mat');
...
%*************************************** Signature AE ****************************************************
file_SignatureAE_Rician3 = matfile('BestModels/Results/SignatureAE/Energy_rician3_c1d2.mat');
file_SignatureAE_Rician10 = matfile('BestModels/Results/SignatureAE/Energy_rician10_c1d2.mat');
file_SignatureAE_Rician20 = matfile('BestModels/Results/SignatureAE/Energy_rician20_c1d2.mat');
file_Feedback_SignatureAE_Rician3 = matfile('BestModels/Results/Feedback_SignatureAE/Energy_rician3_c1d2.mat');
file_Feedback_SignatureAE_Rician10 = matfile('BestModels/Results/Feedback_SignatureAE/Energy_rician10_c1d2.mat');
file_Feedback_SignatureAE_Rician20 = matfile('BestModels/Results/Feedback_SignatureAE/Energy_rician20_c1d2.mat');
...
%*************************************** Baselines ****************************************************
file_psk_rician3 = matfile('BestModels/Results/psk_rician3_c1d2.mat');
file_qam_rician3 = matfile('BestModels/Results/qam_rician3_c1d2.mat');
file_psk_rician10 = matfile('BestModels/Results/psk_rician10_c1d2.mat');
file_qam_rician10 = matfile('BestModels/Results/qam_rician10_c1d2.mat');
file_psk_rician20 = matfile('BestModels/Results/psk_rician20_c1d2.mat');
file_qam_rician20 = matfile('BestModels/Results/qam_rician20_c1d2.mat');
...
semilogy(simParams.EbNoVec,BLER_SimpleAE_Rician3,'-','linewidth',1,'color','#0072BD')
hold on
semilogy(simParams.EbNoVec,BLER_SignatureAE_Rician3,'-*','linewidth',1,'color','#EDB120')
semilogy(simParams.EbNoVec,BLER_ControlAE_Rician3,'-s','linewidth',1,'color','#D95319')
...
title("Frameworks Comparison for Energy Norm, c = 1, d = 2, Rician Factor = 3")
legend("Simple AE",...
...
semilogy(simParams.EbNoVec,BLER_SimpleAE_Rician10,'-','linewidth',1,'color','#0072BD')
hold on
semilogy(simParams.EbNoVec,BLER_SignatureAE_Rician10,'-*','linewidth',1,'color','#EDB120')
semilogy(simParams.EbNoVec,BLER_ControlAE_Rician10,'-s','linewidth',1,'color','#D95319')
...
xlabel('E_b/N_o (dB)','FontName','Times New Roman','FontSize',12)
ylabel('Block Error Rate','FontName','Times New Roman','FontSize',12)
title("Frameworks Comparison for Energy Norm, c = 1, d = 2, Rician Factor = 10")
legend("Simple AE",...
    "AE with Antenna Signature",...
    "Control bit encoded AE",...
    "Baseline SM PSK MLD", ..."Baseline SM QAM MLD", ...
...
semilogy(simParams.EbNoVec,BLER_SimpleAE_Rician20,'-','linewidth',1,'color','#0072BD')
hold on
semilogy(simParams.EbNoVec,BLER_SignatureAE_Rician20,'-*','linewidth',1,'color','#EDB120')
semilogy(simParams.EbNoVec,BLER_ControlAE_Rician20,'-s','linewidth',1,'color','#D95319')
...
xlabel('E_b/N_o (dB)','FontName','Times New Roman','FontSize',12)
ylabel('Block Error Rate','FontName','Times New Roman','FontSize',12)
title("Frameworks Comparison for Energy Norm, c = 1, d = 2, Rician Factor = 20")
legend("Simple AE",...
    "AE with Antenna Signature",...
    "Control bit encoded AE",...
    "Baseline SM PSK MLD", ..."Baseline SM QAM MLD", ...

...
writematrix(train_data,'Datasets\c1d2_rician15\train_data.csv');
writematrix(validation_data,'Datasets\c1d2_rician15\validation_data.csv');
writematrix(test_data,'Datasets\c1d2_rician15\test_data.csv');

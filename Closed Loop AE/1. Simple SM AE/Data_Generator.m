...
writematrix(train_data,'Datasets\c1d3_rician3\train_data.csv');
writematrix(validation_data,'Datasets\c1d3_rician3\validation_data.csv');
writematrix(test_data,'Datasets\c1d3_rician3\test_data.csv');

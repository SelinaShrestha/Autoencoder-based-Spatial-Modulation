...
%save('Results/Power1_rician3_c1d3_EbNo7_batch128_encoder2.mat','BLER');
%save('Models/Power1_rician3_c1d3_EbNo7_batch128_encoder2','wirelessAutoEncoder22e');
...
% save('Results/psk_rician20_c1d2.mat','BLER_psk');
% save('Results/qam_rician20_c1d2.mat','BLER_qam');

...
title("Simple AE with Energy Norm for Rician Factor = 3, c = 1 and d = 2")
...
xlabel('E_b/N_o (dB)','FontName','Times New Roman','FontSize',12)
ylabel('Block Error Rate','FontName','Times New Roman','FontSize',12)
title("Simple AE with Energy Norm for Rician Factor = 10, c = 1 and d = 2")
legend("Eb/No = 7, enc(64), dec(64,64), Batch = 128", ...
"Eb/No = 7, enc(64), dec(64,64), Batch = 512", ...
"Eb/No = 7, enc(64), dec(64,64), Batch = 1024", ...
"Eb/No = 7, enc(64,64), dec(64,64), Batch = 128", ...
...
xlabel('E_b/N_o (dB)','FontName','Times New Roman','FontSize',12)
ylabel('Block Error Rate','FontName','Times New Roman','FontSize',12)
title("Simple AE with Energy Norm for Rician Factor = 20, c = 1 and d = 2")
legend("Eb/No = 7, enc(64), dec(64,64), Batch = 128", ...
"Eb/No = 7, enc(64), dec(64,64), Batch = 512", ...
"Eb/No = 7, enc(64), dec(64,64), Batch = 1024", ...
"Eb/No = 7, enc(64,64), dec(64,64), Batch = 128", ...
...
% xlabel('E_b/N_o (dB)','FontName','Times New Roman','FontSize',12)
% ylabel('Block Error Rate','FontName','Times New Roman','FontSize',12)
% title("Best Models for Simple AE with Energy Norm for c = 1, d = 2, varying Rician Factors")

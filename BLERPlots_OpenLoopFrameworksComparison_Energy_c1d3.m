...
%*************************************** Simple AE ****************************************************
file_SimpleAE_Rician3 = matfile('BestModels/Results/SimpleAE/Energy_rician3_c1d3.mat');
file_SimpleAE_Rician10 = matfile('BestModels/Results/SimpleAE/Energy_rician10_c1d3.mat');
file_SimpleAE_Rician20 = matfile('BestModels/Results/SimpleAE/Energy_rician20_c1d3.mat');
file_Feedback_SimpleAE_Rician3 = matfile('BestModels/Results/Feedback_SimpleAE/Energy_rician3_c1d3.mat');
file_Feedback_SimpleAE_Rician10 = matfile('BestModels/Results/Feedback_SimpleAE/Energy_rician10_c1d3.mat');
file_Feedback_SimpleAE_Rician20 = matfile('BestModels/Results/Feedback_SimpleAE/Energy_rician20_c1d3.mat');
...
%*************************************** Control AE ****************************************************
file_ControlAE_Rician3 = matfile('BestModels/Results/ControlAE/Energy_rician3_c1d3.mat');
file_ControlAE_Rician10 = matfile('BestModels/Results/ControlAE/Energy_rician10_c1d3.mat');
file_ControlAE_Rician20 = matfile('BestModels/Results/ControlAE/Energy_rician20_c1d3.mat');
file_Feedback_ControlAE_Rician3 = matfile('BestModels/Results/Feedback_ControlAE/Energy_rician3_c1d3.mat');
file_Feedback_ControlAE_Rician10 = matfile('BestModels/Results/Feedback_ControlAE/Energy_rician10_c1d3.mat');
file_Feedback_ControlAE_Rician20 = matfile('BestModels/Results/Feedback_ControlAE/Energy_rician20_c1d3.mat');
...
%*************************************** Signature AE ****************************************************
file_SignatureAE_Rician3 = matfile('BestModels/Results/SignatureAE/Energy_rician3_c1d3.mat');
file_SignatureAE_Rician10 = matfile('BestModels/Results/SignatureAE/Energy_rician10_c1d3.mat');
file_SignatureAE_Rician20 = matfile('BestModels/Results/SignatureAE/Energy_rician20_c1d3.mat');
file_Feedback_SignatureAE_Rician3 = matfile('BestModels/Results/Feedback_SignatureAE/Energy_rician3_c1d3.mat');
file_Feedback_SignatureAE_Rician10 = matfile('BestModels/Results/Feedback_SignatureAE/Energy_rician10_c1d3.mat');
file_Feedback_SignatureAE_Rician20 = matfile('BestModels/Results/Feedback_SignatureAE/Energy_rician20_c1d3.mat');
...
title("Frameworks Comparison for Energy Norm, c = 1, d = 3, Rician Factor = 3")
legend("Simple AE",...
...
xlabel('E_b/N_o (dB)','FontName','Times New Roman','FontSize',12)
ylabel('Block Error Rate','FontName','Times New Roman','FontSize',12)
title("Frameworks Comparison for Energy Norm, c = 1, d = 3, Rician Factor = 10")
legend("Simple AE",...
    "AE with Antenna Signature",...
    "Control bit encoded AE",...
    "Baseline SM PSK MLD", ..."Baseline SM QAM MLD", ...
...
xlabel('E_b/N_o (dB)','FontName','Times New Roman','FontSize',12)
ylabel('Block Error Rate','FontName','Times New Roman','FontSize',12)
title("Frameworks Comparison for Energy Norm, c = 1, d = 3, Rician Factor = 20")
legend("Simple AE",...
    "AE with Antenna Signature",...
    "Control bit encoded AE",...
    "Baseline SM PSK MLD", ..."Baseline SM QAM MLD", ...

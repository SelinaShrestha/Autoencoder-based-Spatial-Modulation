...
bits_transmitted = d; % number of bits modulated and transmitted through the transmit signal
...
DataL = DataLayer(Nt, M_d,'DataLayer');
...
if trainNow
  [txNet22e,rxNet22e,info22e,wirelessAutoEncoder22e] = ...
    TrainNetwork_power_constraint_encoder2(n,k,c,SNR,Pmax,normalization,EbNo,KFactorLin); %#ok<*UNRCH>
end
...
title("Simple AE with Power norm for Rician Factor = " + KFactor + ", c = "+ c +" d = " + d)
% subplot(1,2,2)
...
%save('Results/Power1_rician20_c1d3_EbNo15_batch128_encoder2.mat','BLER');
%save('Models/Power1_rician20_c1d3_EbNo15_batch128_encoder2','wirelessAutoEncoder22e');
%save('Results/Power1_rician3_c1d3_EbNo15_batch128_encoder2_128.mat','BLER');
%save('Models/Power1_rician3_c1d3_EbNo15_batch128_encoder2_128','wirelessAutoEncoder22e');
...
%save('Results/psk_rician20_c1d3.mat','BLER_psk');
%save('Results/qam_rician20_c1d3.mat','BLER_qam');
...
xlabel('E_b/N_o (dB)')
ylabel('BLER')
legend("Autoencoder","PSK SM with MLD","QAM SM with MLD")

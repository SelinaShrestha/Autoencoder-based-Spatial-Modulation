...
if trainNow
  [txNet22e,rxNet22e,info22e,wirelessAutoEncoder22e] = ...
    TrainNetwork_encoder2(n,k,c,SNR,normalization,EbNo,KFactorLin); %#ok<*UNRCH>
end
...
for EbNoIdx = 1:length(EbNoVec)
  ...
  frameCnt = 0;
    ...
    ymimo = complex(ymimochan(1,:), ymimochan(2,:)).';            % Convert op of MIMO layer to complex numbersw                                 % AWGN Channel
...
%save('Results/Energy_rician20_c1d3_EbNo15_batch128_encoder2.mat','BLER');
%save('Models/Energy_rician20_c1d3_EbNo15_batch128_encoder2','wirelessAutoEncoder22e');
...
%save('Results/psk_rician50_c1d2.mat','BLER_psk');
%save('Results/qam_rician50_c1d2.mat','BLER_qam');

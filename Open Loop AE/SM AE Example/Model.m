...
if trainNow
  [txNet22e,rxNet22e,info22e,wirelessAutoEncoder22e] = ...
    TrainNetwork(n,k,c,SNR,normalization,EbNo,KFactorLin); %#ok<*UNRCH>
end
...
%title("Simple AE with Energy norm for Rician Factor = " + KFactor + ", c = "+ c +" d = " + d)
% subplot(1,2,2)
...
test_data = readmatrix('datasets\c1d2_rician10\test_data.csv'); %[data pathGains]
...
for EbNoIdx = 1:length(EbNoVec)
  ...
  frameCnt = 0;
    ...
    ymimo = complex(ymimochan(1,:), ymimochan(2,:)).';            % Convert op of MIMO layer to complex numbers
...
%save('Results/Energy_rician20_c1d3_EbNo15_batch128_encoder1.mat','BLER');
%save('Models/Energy_rician20_c1d3_EbNo15_batch128_encoder1','wirelessAutoEncoder22e');

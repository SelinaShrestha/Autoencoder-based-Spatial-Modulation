...
if trainNow
  [txNet22e,rxNet22e,info22e,wirelessAutoEncoder22e] = ...
    TrainNetwork_encoder2(n,k,c,SNR,normalization,EbNo); %#ok<*UNRCH>
end
...
% subplot(1,2,1)
 helperAEWPlotConstellation(txNet22e,'SMLayer')
 %title("AE with Antenna Signature with Energy norm for Rician Factor = " + KFactor + ", c = "+ c +" d = " + d)
% subplot(1,2,2)
...
%save('Results/Energy_rician20_c1d3_EbNo15_batch512_encoder2.mat','BLER');
%save('Models/Energy_rician20_c1d3_EbNo15_batch512_encoder2','wirelessAutoEncoder22e');
%save('Results/Energy_rician20_c1d3_EbNo15_batch128_encoder2_sig0.1.mat','BLER');
%save('Models/Energy_rician20_c1d3_EbNo15_batch128_encoder2_sig0.1','wirelessAutoEncoder22e');
...
xlabel('E_b/N_o (dB)')
ylabel('BLER')
legend("AE with Antenna Signature","SM PSK with MLD","SM QAM with MLD")

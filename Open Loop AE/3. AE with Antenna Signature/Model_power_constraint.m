...
if trainNow
  [txNet22e,rxNet22e,info22e,wirelessAutoEncoder22e] = ...
    TrainNetwork_power_constraint(n,k,c,SNR,Pmax,normalization,EbNo); %#ok<*UNRCH>
else
...
%save('Results/Power1_rician20_c1d3_EbNo15_batch512_encoder1.mat','BLER');
%save('Models/Power1_rician20_c1d3_EbNo15_batch512_encoder1','wirelessAutoEncoder22e');

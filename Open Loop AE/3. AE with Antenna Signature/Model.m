...
if trainNow
  [txNet22e,rxNet22e,info22e,wirelessAutoEncoder22e] = ...
    TrainNetwork(n,k,c,SNR,normalization,EbNo); %#ok<*UNRCH>
end
...
%save('Results/Energy_rician20_c1d3_EbNo15_batch512_encoder1.mat','BLER');
%save('Models/Energy_rician20_c1d3_EbNo15_batch512_encoder1','wirelessAutoEncoder22e');

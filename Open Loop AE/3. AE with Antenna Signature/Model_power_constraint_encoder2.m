...
if trainNow
  [txNet22e,rxNet22e,info22e,wirelessAutoEncoder22e] = ...
    TrainNetwork_power_constraint_encoder2(n,k,c,SNR,Pmax,normalization,EbNo); %#ok<*UNRCH>
else
  load trainedNet_n2_k2_energy info trainedNet
  txNet22e = txNet;
  rxNet22e = rxNet;
  info22e = info;
...
% subplot(1,2,1)
 ...
 title("AE with Antenna Signature with Power norm for Rician Factor = " + KFactor + ", c = "+ c +" d = " + d)
% subplot(1,2,2)
...
%save('Results/Power1_rician20_c1d3_EbNo15_batch512_encoder2.mat','BLER');
%save('Models/Power1_rician20_c1d3_EbNo15_batch512_encoder2','wirelessAutoEncoder22e');
%save('Results/Energy_rician20_c1d3_EbNo15_batch128_encoder1_sig0.1.mat','BLER');
%save('Models/Energy_rician20_c1d3_EbNo15_batch128_encoder1_sig0.1','wirelessAutoEncoder22e');
